...
@SpringBootTest(classes = ServiceRegistryApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles({ "test" })
public class ServiceRegistryApplicationIT {
